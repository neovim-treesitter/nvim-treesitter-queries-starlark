# nvim-treesitter-queries-starlark

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-starlark/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-starlark/actions/workflows/validate.yml)

Neovim tree-sitter queries for **starlark**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-starlark",
...
- [ ] Changes are scoped to `starlark` — do not include files for other languages
